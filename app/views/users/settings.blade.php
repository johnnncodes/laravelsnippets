            ...
            <div class="row">
                <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                    <div class='form-group @if($errors->has('twitter_url')) has-error @endif'>
                        ...
                        @if($errors->has('twitter_url'))<span class="help-block">{{$errors->first('twitter_url')}}</span>@endif
                    </div>
                </div>
                <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                    <div class='form-group @if($errors->has('facebook_url')) has-error @endif'>
                        ...
                        @if($errors->has('facebook_url'))<span class="help-block">{{$errors->first('facebook_url')}}</span>@endif
                    </div>
                </div>
                <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                    <div class='form-group @if($errors->has('github_url')) has-error @endif'>
                        ...
                        @if($errors->has('github_url'))<span class="help-block">{{$errors->first('github_url')}}</span>@endif
                    </div>
                </div>
                <div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
                    <div class='form-group @if($errors->has('website_url')) has-error @endif'>
                        ...
                        @if($errors->has('website_url'))<span class="help-block">{{$errors->first('website_url')}}</span>@endif
                    </div>
                </div>
            </div>
            <div class="row">
