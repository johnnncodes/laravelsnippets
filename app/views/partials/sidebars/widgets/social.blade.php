<div class="sidebar-widget widget-social">
	...
	<ul class="widget-social-icons">
		<li><a href="{{ Config::get('site.twitter_url') }}" target="_blank" class="facebook" title="{{ '@' . Config::get('site.twitter_username') }} on Twitter"><i class="fa fa-facebook"></i></a></li>
		<li><a href="{{ Config::get('site.facebook_url') }}" target="_blank" class="twitter" title="{{ Config::get('site.facebook_username') }} on Facebook"><i class="fa fa-twitter"></i></a></li>
	</ul>
</div>